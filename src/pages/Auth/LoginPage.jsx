...
export default function LoginPage() {
  ...
  const onSubmit = async (v) => {
    ...
    setLoading(true);
    try {
      const session = await login(v.email, v.password);

      // Redirección:
      if (session?.tipo === "Staff_Empresa") {
        navigate("/panel", { replace: true });
      } else {
        // Staff_Clientes mantiene el comportamiento actual
        const from = location.state?.from?.pathname || "/";
  ...
  return (
    <div className="min-h-full grid place-items-center bg-[radial-gradient(1200px_600px_at_10%_10%,rgba(124,58,237,0.25),transparent_40%),radial-gradient(1200px_600px_at_90%_90%,rgba(34,211,238,0.25),transparent_40%),linear-gradient(120deg,#0f172a,#1e293b)] text-zinc-200">
      {/* halos suaves */}
      <div
        className="pointer-events-none fixed inset-0 -z-10 opacity-75 [filter:blur(20px)] 
      ...
      <div className="relative w-[min(92vw,420px)] rounded-2xl border border-white/10 bg-white/10 backdrop-blur-lg shadow-[0_10px_40px_rgba(0,0,0,0.35)] p-7">
        ...
        >
            ...
            <div className="grid grid-cols-[20px_1fr_28px] items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-2.5 py-2">
              ...
              >
                <svg viewBox="0 0 24 24" width="18" height="18">
                  <path
                    fill="currentColor"
                    d="M20 4H4a2 2 0 0 0-2 2v1.2l10 5.8 10-5.8V6a2 2 0 0 0-2-2Zm0 5.25-8.6 5a1 1 0 0 1-1 0L4 9.25V18a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9.25Z"
                  />
                </svg>
              </span>
              <input
            ...
            <div className="grid grid-cols-[20px_1fr_28px] items-center gap-2 rounded-xl border border-white/10 bg-white/10 px-2.5 py-2">
              ...
              >
                <svg viewBox="0 0 24 24" width="18" height="18">
                  <path
                    fill="currentColor"
                    d="M12 1a5 5 0 0 0-5 5v3H5a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-8a2 2 0 0 0-2-2h-2V6a5 5 0 0 0-5-5Zm-3 8V6a3 3 0 0 1 6 0v3H9Z"
                  />
                </svg>
              </span>
              <input
          ...
          <div className="mt-1 text-center text-xs text-slate-400 grid gap-1">
            <div>
              Empresa: <code>admin@empresa.com / admin</code>
            </div>
            <div>
              Cliente: <code>cliente@empresa.com / cliente</code>
            </div>
          </div>
        </form>
